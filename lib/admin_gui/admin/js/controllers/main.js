materialAdmin
    ...
    .controller('materialadminCtrl', function($timeout, $state, $scope, growlService,SetUserService){
        //Welcome Message
    ...
    // Header
    // =========================================================================
    .controller('headerCtrl', function(SetUserService){
        ...
        $scope.getUserName = function (user) {
            ...
            if(user.role == ''){
                ...
                content += user.role.toUpperCase() +' ' + user.name;
            }
