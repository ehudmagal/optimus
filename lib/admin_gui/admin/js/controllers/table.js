materialAdmin
    .controller('tableCtrl', function ($filter, $sce, ngTableParams, tableService, $http, $scope, $rootScope, $compile,
        ...
        if ($location.path().indexOf("private_zone") > -1) {
        ...
        $scope.searchOrdersOnMap = function () {
            ...
            orders = $filter('searchAnything')($scope.orders, $scope.source_address, ['source.address']);
            orders = $filter('searchAnything')($scope.orders, $scope.destination_address, ['destination.address']);
