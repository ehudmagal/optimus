...
.service('PatchObjectFactory', function ($http, $q, $resource) {
        var po = {}
...
.service('SetUserService', function($rootScope){
    var su = {};
    su.setUser = function() {
        $rootScope.devise_user_name = $.cookie("user_name");
        $rootScope.devise_user_email = $.cookie("user_email");
        if( $rootScope.devise_user_name == ""){
