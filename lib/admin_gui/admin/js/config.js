    ...
    .config(function ($stateProvider, $urlRouterProvider){
        ...
        //------------------------------
            ...
            .state ('find_shipments', {
                url: '/home',
                templateUrl: '/views/find_shipments.html',
                resolve: {
                    loadPlugin: function($ocLazyLoad) {
                        return $ocLazyLoad.load ([
                            {
            ...
            .state ('shippers', {
                url: '/home',
                templateUrl: '/views/info_for_shippers.html',
                resolve: {
                    loadPlugin: function($ocLazyLoad) {
                        return $ocLazyLoad.load ([
                            {
            ...
            .state ('carriers', {
                url: '/home',
                templateUrl: '/views/info_for_carriers.html',
                resolve: {
                    loadPlugin: function($ocLazyLoad) {
                        return $ocLazyLoad.load ([
                            {
            ...
            .state ('new_order_dialog', {
                ...
                templateUrl: '/views/new_order_dialog.html',
                resolve: {
                    loadPlugin: function($ocLazyLoad) {
                        return $ocLazyLoad.load ([
                            {
            ...
            .state ('form.new_order', {
                url: '/new_order',
                templateUrl: '/views/new_order-form.html'
            })
