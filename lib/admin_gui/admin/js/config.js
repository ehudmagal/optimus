materialAdmin
    .config(function ($stateProvider, $urlRouterProvider){
        ...
        //------------------------------
            ...
            .state ('home', {
                url: '/home',
                templateUrl: '/admin/views/home1.html',
                resolve: {
            ...
            .state ('find_shipments', {
                url: '/home',
                templateUrl: '/admin/views/find_shipments.html',
                resolve: {
                    loadPlugin: function($ocLazyLoad) {
                        return $ocLazyLoad.load ([
                            {
            ...
            .state ('shippers', {
                url: '/home',
                templateUrl: '/admin/views/info_for_shippers.html',
                resolve: {
                    loadPlugin: function($ocLazyLoad) {
                        return $ocLazyLoad.load ([
                            {
            ...
            .state ('carriers', {
                url: '/home',
                templateUrl: '/admin/views/info_for_carriers.html',
                resolve: {
                    loadPlugin: function($ocLazyLoad) {
                        return $ocLazyLoad.load ([
                            {
            ...
            .state ('new_order', {
                url: '/new_order',
                templateUrl: '/admin/views/new_order.html',
                resolve: {
                    loadPlugin: function($ocLazyLoad) {
                        return $ocLazyLoad.load ([
                            {
            ...
            .state ('new_order_dialog', {
                url: '/new_order_dialog',
                templateUrl: '/admin/views/new_order_dialog.html',
                resolve: {
                    loadPlugin: function($ocLazyLoad) {
                        return $ocLazyLoad.load ([
                            {
            ...
            .state ('form.login', {
                url: '/login',
                templateUrl: '/admin/views/login-form.html'
            })
            .state ('form.signup', {
                url: '/signup',
                templateUrl: '/admin/views/signup-form.html'
            })
            .state ('form.new_order', {
                url: '/new_order',
                templateUrl: '/admin/views/new_order-form.html'
            })
